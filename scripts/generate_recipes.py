...
def create_advancement_json(item_id):
    ...
    """
    advancement = {
        "parent": "decoplus:events/on_deco_block_place",
        "criteria": {
            "place": {
        ...
        "rewards": {
            "function": "decoplus:event_listeners/on_deco_block_place",
            "loot": [
                f"decoplus:{item_id}"
            ]
        }
...
def main():
    ...
    advancement_output_dir = os.path.join(project_root, 'src', 'data', 'decoplus', 'advancement', 'events', 'player_block_place')
